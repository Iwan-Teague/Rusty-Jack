...
./docker/arm32/run.sh env CARGO_TARGET_DIR=/work/target-32 cargo build --target armv7-unknown-linux-gnueabihf -p rustyjack-ui -p rustyjack-daemon -p rustyjack-portal -p rustyjack-core --features rustyjack-core/cli
