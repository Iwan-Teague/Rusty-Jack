...
if ($null -eq $result) {
    ...
    Write-Host "  4. Run this script again: .\scripts\build_arm64.ps1" -ForegroundColor White
    exit 1
}
...
if ([string]::IsNullOrWhiteSpace($output)) {
    ...
    Write-Host "  3. Run this script again: .\scripts\build_arm64.ps1" -ForegroundColor White
    exit 1
}
